...
export function DeskToolsPanel({
  ...
  return (
    <div className="relative border-t border-[#3f392f] bg-[linear-gradient(180deg,rgba(0,0,0,0.1),rgba(0,0,0,0.34))] px-3 pb-4 pt-1">
      ...
      <div className="flex flex-wrap items-end justify-center gap-3 overflow-visible pt-1">
        {tools.map((tool) => {
          return (
            ...
            className={`group relative translate-y-2 text-left transition ${
                tool.unlocked
